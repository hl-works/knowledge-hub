import{s as p}from"./stamps.BbJcI-RE.js";const c={Kazakhstan:["#FA4616","#C9330B"],Kirghizistan:["#149E7C","#0C5A5E"],Mongolie:["#E89B2E","#B86A12"],Chine:["#F2516F","#C12B49"],"Hong-Kong":["#1E96C8","#0C5A7E"],Indonésie:["#149E7C","#0C5A5E"],Malaisie:["#E89B2E","#B86A12"]},r=s=>s.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,""),i=s=>s.replace(/[&<>"]/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[a]);function g(s,a=""){const[t,e]=c[s]??["#FA4616","#C9330B"];return`<div class="pays-head" style="--pc1:${t};--pc2:${e}">
